...
library(gplots)
fileOut<-file.path(outpath,"heatmap_Fst_pops_stacks.png")
png(fileOut,width=16,height=15,units="cm",res=1200, type="cairo")
...
heatmap(
  ...
  xlab = "",
  ylab = "",
  # main = c(expression(paste(italic("L. sardoa")))), cex.main=1.5,
...
# pos=2
# cex_text=1.7
# mtext(paste0(toupper(LETTERS[pos]), ")"), 2, line=-8.8, at=0, padj=-26.1, adj=1, cex=cex_text, las=2, font=2)
