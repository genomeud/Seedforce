...
text(c(1,2,3,4,5,6,7,8,9),0.1+max(full[,1]),c(myletters$Letters[1],myletters$Letters[2],myletters$Letters[3],myletters$Letters[4],myletters$Letters[5],myletters$Letters[6],myletters$Letters[7],myletters$Letters[8],myletters$Letters[9]))
dev.off()
