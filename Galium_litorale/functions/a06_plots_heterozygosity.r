...
# color_list <- c("CH1" = "darkblue","CH2" = "darkmagenta","BZ1" = "maroon", "BZ2" = "palevioletred2","SO1" = "slateblue1","COR" = "peachpuff","MAL" = "skyblue1","CN1" = "mediumaquamarine", "ALL"="white")
...
full$NAME <- factor(full$NAME, levels = pops)
...
boxplot(full$EXP_HET ~ full$NAME, xlab = "Category",ylab = "Expected heterozygosity Stacks", levels = pops, col = colors,range = 0.1,main = "Expected heterozygosity",frame = FALSE, top = TRUE, outline=FALSE,ylim=c(0,0.3))
dev.off()
...
boxplot(full$OBS_HET ~ full$NAME, xlab = "Category",ylab = "Observed heterozygosity", levels = pops, col = colors,range = 0.1,main = "Observed heterozygosity",frame = FALSE, top = TRUE, outline=FALSE,ylim=c(0,0.3))
dev.off()
