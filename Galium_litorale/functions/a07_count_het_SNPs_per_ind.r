...
result$color<-"black"
result$color[result$Population=="SOS"]<-"gray68"
result$color[result$Population=="BIA"]<-"orchid2"
result$color[result$Population=="BCO1"]<-"seagreen"
result$color[result$Population=="BCO2"]<-"tomato2"
result$color[result$Population=="BA2"]<-"hotpink4"
result$color[result$Population=="BA5"]<-"steelblue"
result$color[result$Population=="BA6"]<-"chartreuse1"
result$color[result$Population=="BA4"]<-"mediumpurple"
result$color[result$Population=="BA1"]<-"yellow4"
result$color[result$Population=="CUS"]<-"orange"
result$color[result$Population=="3F"]<-"darkseagreen"
result$color[result$Population=="TR1"]<-"coral4"
...
legend ("bottomright",  ncol = 1, legend = c("SOS","BIA","BCO1","BCO2","BA2","BA5","BA6","BA4","BA1","CUS","3F","TR1","ALL"), col=c("gray68","orchid2","seagreen","tomato2","hotpink4","steelblue","chartreuse1","mediumpurple","yellow4","orange","darkseagreen","coral4"), text.col=c("gray68","orchid2","seagreen","tomato2","hotpink4","steelblue","chartreuse1","mediumpurple","yellow4","orange","darkseagreen","coral4"), x.intersp = 0.5 , y.intersp = 1 , pt.cex = 1 , cex = 0.6, bty = "n" )
...
color_list=c("gray68","orchid2","seagreen","tomato2","hotpink4","steelblue","chartreuse1","mediumpurple","yellow4","orange","darkseagreen","coral4")
