...
group_colors <- c("CRE" = "turquoise","ISS" = "seagreen","LSO" = "orchid2","MOL" = "lightgoldenrod", "PLA" = "tomato2","RIC" = "steelblue","RMA"="gray68","TON" = "hotpink4")
...
pdf(out_unroot, width=8, height=7)

plot.phylo(tree, tip.color=tip_colors, type = "unrooted", cex=0.45, label.offset=0.05, main="Phylogenetic Tree")
legend("bottomright", legend=names(group_colors), fill=group_colors, cex=0.7, border=FALSE, bty="n")
dev.off()
