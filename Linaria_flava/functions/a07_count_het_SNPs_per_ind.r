...
result$color<-"black"
result$color[result$Population=="RMA"]<-"gray68"
result$color[result$Population=="LSO"]<-"orchid2"
result$color[result$Population=="ISS"]<-"seagreen"
result$color[result$Population=="PLA"]<-"tomato2"
result$color[result$Population=="TON"]<-"hotpink4"
result$color[result$Population=="RIC"]<-"steelblue"
result$color[result$Population=="MOL"]<-"lightgoldenrod"
result$color[result$Population=="CRE"]<-"turquoise"
...
legend ("bottomright",  ncol = 1, legend = c("RMA", "LSO", "ISS", "PLA", "TON", "RIC", "MOL", "CRE"), col=c("gray68", "orchid2", "seagreen", "tomato2","hotpink4","steelblue", "lightgoldenrod", "turquoise"), text.col=c("gray68", "orchid2", "seagreen", "tomato2","hotpink4","steelblue", "lightgoldenrod", "turquoise"), x.intersp = 0.5 , y.intersp = 1 , pt.cex = 1 , cex = 0.6, bty = "n" )
...
color_list=c("turquoise","seagreen","orchid2","lightgoldenrod","tomato2","steelblue","gray68","hotpink4")
...
color_list <- c("CRE" = "turquoise","ISS" = "seagreen","LSO" = "orchid2","MOL" = "lightgoldenrod", "PLA" = "tomato2","RIC" = "steelblue","RMA"="gray68","TON" = "hotpink4")
