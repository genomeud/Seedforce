...
# Spp are listed in ${raw_files}/population_files_per_spp/spp.txt. Ex.
# ALI
# AVE
# BSA
...
[[ "$spp" =~ \#.* ]]&& continue
    ...
    Rscript /projects/marroni/seedforce/scripts/plots_HWE_pool_1catalog_per_spp_pops.r ${spp} ${pop}
    echo -e "I finished Rscript $spp $pop\n"
    echo -e "I finished POOL de novo pipeline $spp ${pop}\n"
...
do
    sleep 1
    Rscript /projects/marroni/seedforce/scripts/distance_pool_PPB.r -s ${spp} -I ${out1}/${spp}/ -o ${out1}/${spp}/PCA.pdf -O ${out1}/${spp}/ -S distance &
done < ${raw_files}/population_files_per_spp/spp.txt
...
do
    sleep 1
    Rscript /projects/marroni/seedforce/scripts/distance_pool_PPB.r -s ${spp} -I ${out1}/${spp}/ -o ${out1}/${spp}/PCA.pdf -O ${out1}/${spp}/ -S plot &
done < ${raw_files}/population_files_per_spp/spp.txt
